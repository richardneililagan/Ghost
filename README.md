...
This is a customized version of the core [Ghost](https://github.com/TryGhost/Ghost) platform.

Check out the modifications made to this in the [Modifications log](https://github.com/richardneililagan/Ghost/blob/master/MODIFICATIONS>md).
